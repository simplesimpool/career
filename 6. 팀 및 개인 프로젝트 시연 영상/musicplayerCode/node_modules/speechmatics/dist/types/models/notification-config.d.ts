...
export declare const NotificationConfigContentsEnum: {
    readonly Jobinfo: "jobinfo";
    readonly Transcript: "transcript";
    readonly TranscriptJsonV2: "transcript.json-v2";
    readonly TranscriptTxt: "transcript.txt";
    readonly TranscriptSrt: "transcript.srt";
    readonly Alignment: "alignment";
    readonly AlignmentWordStartAndEnd: "alignment.word_start_and_end";
    readonly AlignmentOnePerLine: "alignment.one_per_line";
    readonly Data: "data";
    readonly Text: "text";
};
export type NotificationConfigContentsEnum = typeof NotificationConfigContentsEnum[keyof typeof NotificationConfigContentsEnum];
export declare const NotificationConfigMethodEnum: {
    readonly Post: "post";
    readonly Put: "put";
};
export type NotificationConfigMethodEnum = typeof NotificationConfigMethodEnum[keyof typeof NotificationConfigMethodEnum];
