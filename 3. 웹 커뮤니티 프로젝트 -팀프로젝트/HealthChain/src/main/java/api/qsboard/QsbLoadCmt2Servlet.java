...
@WebServlet("/QsbLoadCmt2Servlet")
public class QsbLoadCmt2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QsbLoadCmt2Servlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PagingData cmt2PgData = qsbCmt2Dao.getPagingData(1, qsbId, qsbCmtId);
