...
<script type="text/javascript">
	...
	async function cmtWriteAction() {
		...
		await axios.post("http://localhost:8080/HealthChain/RvbCmtWriteServlet", {
	...
	async function userActivityChk() {
		...
		try {
			response = await axios.post("http://localhost:8080/HealthChain/RvbCmtCheckUserActivityServlet", {
