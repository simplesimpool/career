 ...
 * @export
 * @interface BatchTranscriptionConfigSpeakerDiarizationConfig
 */
export interface BatchTranscriptionConfigSpeakerDiarizationConfig {
    /**
     ...
     * @type {number}
     * @memberof BatchTranscriptionConfigSpeakerDiarizationConfig
     */
