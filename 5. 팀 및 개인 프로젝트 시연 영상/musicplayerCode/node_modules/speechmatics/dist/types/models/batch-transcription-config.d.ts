...
export declare const BatchTranscriptionConfigDiarizationEnum: {
    readonly None: "none";
    readonly Speaker: "speaker";
    readonly Channel: "channel";
    readonly SpeakerChange: "speaker_change";
    readonly ChannelAndSpeakerChange: "channel_and_speaker_change";
};
export type BatchTranscriptionConfigDiarizationEnum = typeof BatchTranscriptionConfigDiarizationEnum[keyof typeof BatchTranscriptionConfigDiarizationEnum];
export declare const BatchTranscriptionConfigMaxDelayModeEnum: {
    readonly Fixed: "fixed";
    readonly Flexible: "flexible";
};
export type BatchTranscriptionConfigMaxDelayModeEnum = typeof BatchTranscriptionConfigMaxDelayModeEnum[keyof typeof BatchTranscriptionConfigMaxDelayModeEnum];
