...
@WebServlet("/QsbLoadServlet")
public class QsbLoadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QsbLoadServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ///////////////////////////////////////////////////////////////////여기까지 qsbId 가져오는 파트 각각의 게시판에 대한 id가 필요하므로
        ...
        PagingData cmtPgData = qsbCmtDao.getPagingData(1, qsbId);
