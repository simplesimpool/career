...
/**
 * Servlet implementation class CsBoardCheckUserActivityServlet
 */
@WebServlet("/CsBoardCheckUserActivityServlet")
public class CsBoardCheckUserActivityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public CsBoardCheckUserActivityServlet() {
        super();
