...
<body>
	...
	<script type="text/javascript">
		...
		function boardSelectAction() {
			...
			location.href = "noticeListController.sg?boardCategory=" + value + "&page=${pgData.page}";
		...
		function pageClickAction(page) {
			const value = document.querySelector("#board-category").value;
			location.href = "noticeListController.sg?boardCategory=" + value + "&page=" + page;
		}
		function moveToPage() {
			...
			if(inputPage === "") {
				...
				location.href = "noticeListController.sg?boardCategory=" + value + "&page=" + inputPage;
			}
		}
		function contentClickAction(id, category) {
			location.href = "noticeContent.sg?category=" + category + "&id=" + id;
		}
	</script>
