		...
		<div class="container">
			<div
				...
				<a href="main.jb"
					...
					헬스체인 </a>
				<form class="col-7 mb-3 mb-lg-0 me-lg-5"
					onsubmit="return searchChk()" action="srBoard.sg" method="get">
					<input type="search"
						class="form-control form-control-white search-input"
				...
				<div class="text-end">
					<div class="dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dLabel">
							...
							%>
							<li><a class="dropdown-item" href="adminPageController.sg?category=userList">관리자페이지</a></li>
							<%
							} else {
							%>
		...
		<div id="carouselExampleAutoplaying" class="carousel slide"
			...
			<div class="carousel-inner" id="inner">
				<div class="carousel-item">
					<img src="./view/main/images/image1.png" class="d-block w-100"
						alt="...">
				</div>
				<div class="carousel-item">
					<img src="./view/main/images/image2.png" class="d-block w-100"
						alt="...">
				</div>
				<div class="carousel-item active">
					<img src="./view/main/images/image3.png" class="d-block w-100"
						alt="...">
				</div>
			</div>
			...
			<div class="row align-items-md-stretch" style="width: auto;"
				...
				<div class="col-md-6" style="width: 40%">
					<div class="h-100 p-4 pt-5 rounded-3" id="questgo"
						...
						<button class="btn btn-outline-light" type="button"
							onclick="sessionChk()">질문 하러가기⇀</button>
				...
				<div class="col-md-6 rounded-3" style="width: 60%">
					<div class="h-100 p-3 pt-4 text-black bg-white rounded-3">
						...
						<%-- <c:if test="${empty rvbList }">
							<div>추천글이 없습니다.</div>
							<button class="btn btn-outline-dark" type="button"
								onclick="location.href='qsBoardWriteForm.sg'">추천 하러가기⇀</button>
						</c:if> --%>
...
<script
	...
	<script type="text/javascript">
		...
		async function reqLoadData() {
			try {
				loadRes = await axios.get("http://localhost:8080/HealthChain/LoadDataServlet");
			}
			catch(error) {
				loadRes = null;
				console.error(error);
	...
	<script type="text/javascript">
		...
		function sessionChk() {
			...
			if (userId !== "null") {//세션이 존재
				if (userId === "" + loadRes.data.adminId) {
					alert("관리자는 질문할 수 없습니다");
				} else {
					location.href = "qsBoardWriteForm.sg";
				}
			}
			else {//세션이 없음
				const result=confirm("비회원은 게시글을 작성할 수 없습니다. 로그인 하시겠습니까?");
				if(result){
					location.href="loginForm.sw";
				}
			}
		}
	</script>
