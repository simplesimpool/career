...
<form action="qsBoardUpdate.sg" method="post">
	...
	<input id="title" type="text" name="title" value="${qsb.getQsb_title() }" required="required" autofocus="autofocus" maxlength="20" placeholder="최대 20자">
	
	<label for="content">글내용:</label>
	<textarea id="content" name="content" required="required" autofocus="autofocus" maxlength="800" placeholder="최대 800자">${qsb.getQsb_content() }</textarea>
