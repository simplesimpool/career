...
<body>
	...
	<table border="1">
		...
		<c:forEach var="board" items="${boardList}" varStatus="status">
			<tr>
				<td colspan="6">
					<div class="board-container ${userList.get(status.index).getUser_nickname() == '관리자' ? 'admin-background' : ''}" onclick="moveToContent(${board.getRvb_id() })">  
