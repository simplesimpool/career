...
@WebServlet("/QsbCmt2ReplyCheckUserActivityServlet")
public class QsbCmt2ReplyCheckUserActivityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QsbCmt2ReplyCheckUserActivityServlet() {
        super();
    }
